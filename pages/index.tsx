...
const Home = (): JSX.Element => (
  <>
    ...
    <p className="dark:text-gray-400 text-gray-500">
      ...
      <Link href="/labs">
        <span className="underline text-gray-800 font-medium dark:font-normal dark:text-gray-200 dark:hover:text-amber-300 hover:text-amber-500 cursor-pointer">
          tools
        </span>
      </Link>{" "}
    ...
    <div>
      ...
      <p className="dark:text-gray-400 mb-8 text-gray-500">
      ...
      <div className="flex items-baseline justify-between gap-4 my-4">
        ...
        <span className="dark:text-gray-500 text-sm text-gray-400">
          08/2020 - Present
        </span>
      </div>
