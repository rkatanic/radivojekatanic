          ...
          <Heading>
            ...
            <span className="relative z-10">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute left-0 top-2/3 -z-[1] h-[0.58em] w-full fill-indigo-200/70 dark:fill-teal-800"
          ...
          <Heading>
            ...
            <span className="relative z-10">
              ...
              <svg
                ...
                viewBox="0 0 281 40"
                preserveAspectRatio="none"
                className="absolute left-0 top-1/3 -z-[1] h-[1em] w-full fill-indigo-200/70 dark:fill-teal-900"
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
