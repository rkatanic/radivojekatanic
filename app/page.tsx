...
const Home = () => (
  <div>
    ...
    <div className="prose prose-zinc relative dark:prose-invert prose-headings:text-zinc-100 prose-a:border-b prose-a:border-b-red-500 prose-a:no-underline prose-a:dark:text-zinc-100">
      ...
      <ul className="mb-6 mt-10 pl-3.5">
        <ListItem
          ...
          description={
            <div>
              <p>
                {" "}
                Started career as a Software Developer at{" "}
                <a
                  href="https://productdock.com/"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <p>
                ...
                where I developed with other candidates internal application for
                employee management. Main tech stack was Angular, Spring Boot
                and MySQL.
              </p>
              <p>
        ...
        <ListItem
          ...
          description={
            <p>
              ...
              <br className="hidden sm:block" /> Doboj, Bosnia and Herzegovina.
            </p>
          }
        />
        <ListItem
