...
const Home = () => (
  <div className="mx-auto min-h-screen max-w-5xl py-16">
    {/* <Header /> */}
    <HeroSection />
    <StatsSection />
    <ServicesSection />
    ...
    <section className="relative overflow-hidden border border-t-0">
      <div
        ...
        >
          ...
          Part time availability
            ...
            <p className="text-muted-foreground text-lg/relaxed">
              Push the boundaries of innovation and optimization with our
              platform. Excel in your operations and deliver exceptional value
              to your customers.
            </p>
